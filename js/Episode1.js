               ...
               var intro = createElement("h2");
                ...
                Scene1.position(width/2-700, height/2+90);
                    ...
                    OptionA.mousePressed(() => {
                        ...
                        Adc.position(width/2-700, height/2+200);
                        Adc.style("color","yellow");
                        var Alright = createButton("Alright!")
                        Alright.position(width/2+50, height/2-95);
                    ...
                    OptionB.mousePressed(() => {
                        ...
                        Bdc.position(width/2-700, height/2+200);
                    ...
                    OptionC.mousePressed(() => {
                        ...
                        Cdc.position(width/2-700, height/2+200);
                    ...
                    OptionD.mousePressed(() => {
                        ...
                        Ddc.position(width/2-700, height/2+200);
                    ...
                    Next1.position(width/2+50,height/2-50);
                    ...
                    OptionA2.mousePressed(() => {
                            ...
                            Adc2.position(width/2-700, height/2+200);
                    ...
                    Alright.style("fontSize","20px");
                        ...
                        score = score-5;
                            ...
                            Bdc2.position(width/2-700, height/2+200);
                        ...
                        score = score-5;
                            ...
                            Cdc2.position(width/2-700, height/2+200);
                    ...
                    Next2.position(width/2+50, height/2-50);
                    ...
                    OptionD3.style("fontSize","20px");
                        ...
                        OptionA3.mousePressed(() => {
                            ...
                            Adc3.position(width/2-700,height/2+200);
                        ...
                        score = score-5;
                            ...
                            Bdc3.position(width/2-700,height/2+200);
                        ...
                        score = score-5;
                            ...
                            Cdc3.position(width/2-700,height/2+200);
                        ...
                        score = score-5;
                            ...
                            Ddc3.position(width/2-700,height/2+200);
                    ...
                    Next3.position(width/2+50,height/2-50);
                    ...
                    Next3.mousePressed(() => {
                        ...
                        situation4.position(width/2-700,height/2+90)                        
                        var password1 = createInput("");
                        password1.position(width/2, height/2-95);
                        

                        var Reset = createButton("RESET");
                        Reset.position(width/2,height/2-50);
                        ...
                        Reset.mousePressed(()=>{
                            ...
                            message.position(width/2-700, height/2+200);
                            message.style("color","yellow");


                            var nextEpisode = createButton("Go!");
                            nextEpisode.position(width/2+50,height/2-50);
