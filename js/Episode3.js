class Episode3{
    ...
    display(){
        ...
        intro3.position(width/2-170, height-600);
        ...
        description3.position(width/2-700,height/2+90);
        
        var beginbutton3 = createButton("Begin>");
        beginbutton3.position(width/2,height/2-95)
        ...
        beginbutton3.mousePressed(() => {
            ...
            // 1
                    ...
                    OptionCE2.position(width/2+100,height/2-200);
                    ...
                    OptionAE2.mousePressed(() => {
                        ...
                        AdcE2.position(width/2-700, height/2+200);
                    ...
                    OptionBE2.mousePressed(() => {
                        ...
                        BdcE2.position(width/2-700,height/2+200);
                        var Alright = createButton("Alright!")
                        Alright.position(width/2+50,height/2-95);
                        Alright.style("backgroundColor","yellow");
                            Alright.style("fontSize","20px");
                    ...
                    OptionCE2.mousePressed(() => {
                        ...
                        CdcE2.position(width/2-700, height/2+200);
                        var Alright = createButton("Alright!")
                        Alright.position(width/2+50,height/2-95);
                        Alright.style("backgroundColor","yellow");
                            Alright.style("fontSize","20px");
...
// 2
            ...
            nextbutton.position(width/2+50, height/2-50);
            ...
            situationE3.position(width/2-700, height/2+90);
            
            var OptionAE3 = createButton("Call Amajon Security Department");
            OptionAE3.position(width/2-200,height/2-200);
            ...
            OptionBE3.position(width/2-200,height/2-100);
            ...
            OptionCE3.position(width/2-200,height/2-150);
            ...
            OptionAE3.mousePressed(() => {
                ...
                AdcE3.position(width/2-700, height/2+200);
                var Alright = createButton("Alright!")
                Alright.position(width/2+50, height/2-95);
                Alright.style("backgroundColor","yellow");
                            Alright.style("fontSize","20px");
            ...
            OptionBE3.mousePressed(() => {
                ...
                BdcE3.position(width/2-700,height/2+200);
                var Alright = createButton("Alright!")
                Alright.position(width/2+50,height/2-95);
                Alright.style("backgroundColor","yellow");
                            Alright.style("fontSize","20px");
            ...
            OptionCE3.mousePressed(() => {
                ...
                CdcE3.position(width/2-700,height/2+200);
                var Alright = createButton("Alright!")
                Alright.position(width/2+50,height/2-95);
                Alright.style("backgroundColor","yellow");
                            Alright.style("fontSize","20px");
            ...
            Next1E3.position(width/2+50,height/2-50);
