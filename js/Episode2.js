class Episode2{
    ...
    display(){
        var intro2 = createElement("h2");
                ...
                intro2.position(width/2-170, height-600);
                ...
                description2.position(width/2-700, height/2+90);
                description2.style("fontSize","20px")
                
                var beginbutton2 = createButton("Begin>");
                beginbutton2.position(width/2,height/2-95)
                beginbutton2.style("backgroundColor","yellow");
                    ...
                    OptionAE2.position(width/2-100,height/2-200);
                    ...
                    Next1E2.position(width/2+50,height/2-50);
                    ...
                    Next1E2.mousePressed(() => {
                        ...
                        situation2E2.position(width/2-700,height/2+90);
                        var password2 = createInput("")
                        password2.position(width/2,height/2-95);
                        
                        var reset2= createButton("RESET")
                        reset2.position(width/2,height/2)
