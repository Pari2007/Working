class Episode4{
    ...
    display(){
                ...
                intro4.position(width/2-120, height-600);
                ...
                description4.position(width/2-700,height/2+90);
                
                var beginbutton4 = createButton("Begin>");
                beginbutton4.position(width/2,height/2-95)
                ...
                beginbutton4.mousePressed(() => {
                    ...
                    OptionA4.position(width/2-100,height/2-200);
                    OptionA4.style("backgroundColor","pink");
                    OptionA4.style("fontSize","20px");
                    
                    var OptionB4 = createButton("No,Never!");
                    OptionB4.position(width/2-100,height/2-100);
                    OptionB4.style("backgroundColor","pink");
                    OptionB4.style("fontSize","20px");
                    ...
                    OptionA4.mousePressed(() => {
                        ...
                        Adc4.position(width/2-700,height/2+200);
                    ...
                    OptionB4.mousePressed(() => {
                        ...
                        Bdc4.position(width/2-700,height/2+200);
                        var Alright = createButton("Alright!")
                    Alright.position(width/2+50,height/2-95);
                    Alright.style("backgroundColor","yellow");
                            Alright.style("fontSize","20px");
                    ...
                    Next3.mousePressed(() => {
                        ...
                        situationE4.position(width/2-700,height/2+90);
                        
                        var OptionAE4 = createButton("Report to local enforcement immediately");
                        OptionAE4.position(width/2-100,height/2-200);
                    ...
                    OptionBE4.style("fontSize","20px");
                        ...
                        OptionAE4.mousePressed(() => {
                            ...
                            AdcE4.position(width/2-700, height/2+200);
                            var Alright = createButton("Alright!")
                        Alright.position(width/2+50, height/2-95);
                        Alright.style("backgroundColor","yellow");
                            Alright.style("fontSize","20px");
                        ...
                        OptionBE4.mousePressed(() => {
                            ...
                            BdcE4.position(width/2-700,height/2+200);
                            var Alright = createButton("Alright!")
                        Alright.position(width/2+50, height/2-95);
                        Alright.style("backgroundColor","yellow");
                            Alright.style("fontSize","20px");
                        ...
                        OptionCE4.mousePressed(() => {
                            ...
                            CdcE4.position(width/2-700,height/2+200);
                            var Alright = createButton("Alright!")
                        Alright.position(width/2+50,height/2-95);
                        Alright.style("backgroundColor","yellow");
                            Alright.style("fontSize","20px");
                    ...
                    finishbutton.position(width/2+50,height/2-50)
